...
namespace AnimalRescue.Caching
{
    ...
    /// <summary>
    /// Abstract base class that provides all required functionality for the derived classes.
    /// The base class will protect from collisions of cached objects between derived classes.
    /// The embedded cache provider can be replaced to handle environmental concerns, such as 
    /// system scaling.
    /// </summary>
